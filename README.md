...
An end-to-end pipeline that turns a topic into a narrated, captioned, vertical
short-form video and publishes it to Instagram Reels.

All content is either AI-generated (script, voiceover) or sourced from
licensed stock footage (Pexels) — nothing is scraped or reposted from other
creators.
...
```
topic
  -> script + per-scene visual keywords     (Anthropic Claude)
...
python main.py "weird facts about deep sea creatures" --no-publish
```
